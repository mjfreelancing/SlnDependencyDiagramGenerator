...
4. Support tool detection and explicit path overrides in non-interactive environments.
...
| ID     | Requirement                                                                                                           |
| ------ | --------------------------------------------------------------------------------------------------------------------- |
| FR-7.1 | Build configuration shall support a conditional dependency mode switch (for example, `UseLocalGeneratorProjectRefs`). |
| FR-7.2 | Local development mode shall support project references to local generator source.                                    |
...
3. Dual dependency mode discipline: validate both project-reference and package-reference modes.
